...
module.exports.config = {
  ...
  version: "1.0.0",
  hasPermssion: 0,
  credits: "Kaneki (fixed by Siegfried Sama)",
...
"https://i.postimg.cc/rs573S8Q/tumblr-os64hm-Sc-AN1smwom8o10-1280.gif",
   ...
   var callback = () => api.sendMessage({body:`${tag}` + ` sarap 😋`,mentions: [{tag: tag,id: Object.keys(event.mentions)[0]}],attachment: fs.createReadStream(__dirname + "/cache/bopmong.gif")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/bopmong.gif"));  
